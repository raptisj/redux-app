			...
			<p>Add all infomation about your place</p>
				<form onSubmit={handlePost}>
					<div className="create-form__field">
						...
						<input type="text" className="create-form__input" onChange={(e) => setName(e.target.value)} />
					</div>
					<div className="create-form__field">
						<label className="create-form__label">Country:</label>
						<input type="text" className="create-form__input"  onChange={(e) => setCountry(e.target.value)} />
					</div>
					<div className="create-form__field">
						<label className="create-form__label">Subtitle:</label>
						<input type="text" className="create-form__input" onChange={(e) => setSubtitle(e.target.value)} />
					</div>
					<div className="create-form__field">
